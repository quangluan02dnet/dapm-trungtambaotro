...
import { Input, Select, Table, Button, message, Popconfirm } from 'antd';
...
const AdoptionProfileManagement = () => {
    ...
    },
    {
      ...
      render: (text, record) => (
        <Button
          icon={<CheckOutlined />}
          type="primary"
          onClick={() => handleReview(record.idHoso)}
          disabled={record.trangThai === '1'}
        >
          Phê duyệt
        </Button>
      ),
...
export default AdoptionProfileManagement;
